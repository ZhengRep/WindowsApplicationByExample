...
public:
	TextFigure();
	TextFigure(const Color& color, const CPoint& ptMouse, const Font& font, CDC* pDC);
	...
	BOOL CharDown(UINT uChar, CDC* pDC, KeyboardState eKeyboardState);
...
public:
	CRect GetCaretArray(KeyboardState eKeyboardState);
